 ...
 * Noise Removal
 *
 * We can remove patches of high intensity in an image by blurring it.
 * Box blur and Gaussian blur are one of the many blurring methods.
 *
 * https://dev.to/mathewthe2/using-javascript-to-preprocess-images-for-ocr-1jc
 *
 */

import { setPixels, getARGB } from "./helper";
...
function dilate(pixels, canvas) {
	...
	return setPixels(pixels, out);
}

export { buildBlurKernel, blurARGB, dilate };
